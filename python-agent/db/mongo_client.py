...
def get_last_report(competitor: str) -> str:
...
def get_all_competitors() -> list:
    ...
    return list(sync_db.competitors.find({}, {"_id": 0}))
...
async def async_get_reports(competitor: str = None, limit: int = 50):
...
async def async_get_competitors():
    """Saare competitors async mein nikalo"""
    cursor = async_db.competitors.find({}, {"_id": 0})
